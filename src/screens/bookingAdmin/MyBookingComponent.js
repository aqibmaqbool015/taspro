...
function BookingComponent({ scheduleHomeCards }) {
        ...
        <Container>
          <Row>
            ...
            <Col lg={{ span: 9 }}>
              ...
              <div className="mt-3 text-center" onClick={handleClicks}>
                <span
                  className="box-cart-empty-label"
                  onClick={() => navigate(Screens.bookingServiceDetail)}
                >
      ...
      <section className="service-home-section">
        <Container>
          <div className="mt-2 user-multi-services-slides">
            <Row>
              <Col lg={{ span: 12 }}>
                <div className="mt-2 user-multi-services-slides user-multi-services-cleaning">
