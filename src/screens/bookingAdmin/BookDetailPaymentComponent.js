              ...
              <Row>
                <Col lg={{ span: 6 }} sm={{ span: 12 }} xs={{ span: 12 }}>
                  ...
                  font-weight-600 mb-3"
                    ...
                    border-bottom-container"
                      ...
                      <div
                        id="work-status"
                        className="timeline-vertical-detail-container mt-4 mb-2"
                      >
                        <h6 className="user-power-title user-power-title-repair mb-2 mt-5">
                          Work Status
                        </h6>
                        <ul className="timeline">
                          {timelineDetail.map((item, index) => (
                            <li className="timeline-inverted mb-4" key={index}>
                ...
                <Col lg={{ span: 6 }} sm={{ span: 12 }} xs={{ span: 12 }}>
                  ...
                  >
                    ...
                    <div className="">
                      {amountSummaryDetail.map((item, index) => {
                        return (
                          <>
