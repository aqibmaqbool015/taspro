...
import CartModal from "../../../commonComponents/servicesModal/CartModal";
...
function ServiceCartCoupons() {
  ...
  const handleBackToAddCapacityModal = () => {
    setShowSecondModal(false);
  ...
  return (
    <>
              ...
              >
                ...
                user-cleaning-container-carts-position"
                  >
                    ...
                    <li className="user-cleaning-detail" onClick={handleClicks}>
                      <Button
      ...
      <AmcModal
        ...
        onBack={handleBackToAddCapacityModal}
      />
      <CartModal
        show={showThirdModal}
