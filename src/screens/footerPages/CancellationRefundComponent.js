...
import "../admin.css";
import { privacyTextArray } from "../../constant/accountDummyData";
import AddressUpdateDropdown from "../../commonComponents/AddressUpdateDropdown";
function CancellationRefundComponent() {
              ...
              <div className="user-account-language-controller">
                <h6
                  className="user-power-title
                            ...
                            account-language-controller-screen
                            mb-3 mt-2"
                >
                  Cancellation & Refund
                </h6>
                ...
                <ul className="px-0">
                  {privacyTextArray.map((item, index) => {
                    return (
                      <>
                        <p className="account-about-description">{item}</p>
                      </>
                    );
                  })}
                </ul>
